...
-- =============================================
CREATE PROCEDURE [dbo].[BackUp_дата]
AS
  BEGIN
      ...
      ELSE
        SET @filepath = N'D:\MSSQL\Backup\Hotel_2016_Hot_' + REPLACE(CONVERT(NVARCHAR(10), Getdate(), 102), '.', '_') + '_' + REPLACE(CONVERT(NVARCHAR(5), Getdate(), 108), ':', '_') + '.bak'
